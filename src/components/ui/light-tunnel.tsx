...
export default function LightTunnel({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: {
          value: new Float32Array([0.65882353, 0.33333333, 0.96862745]),
        },
        uPulseColor: {
          value: new Float32Array([0.65882353, 0.33333333, 0.96862745]),
        },
        uTunnelColor: {
          value: new Float32Array([0.32156863, 0.15294118, 1]),
        },
  ...
  useEffect(() => {
    ...
    cableColor, pulseColor, tunnelColor, tunnelOpacity, speed, flowDirection,
    pulseSpeed, pulseLength, pulseBlend, pulseWidth, cableCount, thickness,
    rimWidth, waviness, sway, size, centerX, centerY, glow, fadeNear, fadeFar,
    brightness, colorVariance, grain, grainIntensity, opacity, mouseInteraction,
    mouseStrength,
  ]);
