    ...
    <div style={{ padding: "0 clamp(1.5rem,4vw,4rem) 2rem", maxWidth: 1180, margin: "0 auto" }}>
      ...
      >
        ...
        <div className="flex gap-[1.4rem]">
          <a href="#" className="no-underline transition-colors duration-300 hover:text-[var(--cream)]" style={{ fontSize: ".74rem", color: "var(--cream-46)" }}>Gizlilik</a>
          <a href="#" className="no-underline transition-colors duration-300 hover:text-[var(--cream)]" style={{ fontSize: ".74rem", color: "var(--cream-46)" }}>Kullanım Koşulları</a>
